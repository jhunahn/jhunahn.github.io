...
layout: post
comments: true
date: 2018-01-05 09:48
image: /assets/images/samples/markdown.jpg
headerImage: true
tag:
- markdown
category: Language
...
<div class="side-by-side">
    <div class="toleft">
        <img class="image" src="{{ site.url }}/assets/images/samples/sample_001.gif" alt="Alt Text">
        <figcaption class="caption">drop the caption. yo</figcaption>
    </div>
...
<div class="side-by-side">
    ...
    <div class="toright">
         <img class="image" src="{{ site.url }}/assets/images/samples/sample_002.gif" alt="Alt Text">
        <figcaption class="caption">drop the caption. yo</figcaption>
    </div>
</div>
{% endhighlight %}
...
<div class="spoiler"><p>Watch out for the spoiler!</p></div>
